    ...
    return (
        <div className="searchPage">
            ...
            <SearchResult
                ...
                title="Séjournez dans cette spacieuse maison de style Edouardienne"
                description="1 voyageur · Studio · 1 salle de bain · 1 lit · Wifi · Cuisine · Parking gratuit"
                star={4.73}
                price="£30 / nuit"
                total="£117 total"
            />
            ...
            <SearchResult
                ...
                description="2 voyageurs · 1 chambre · 2 lits · 1 salle de bain privée · Wifi · Climatisation · Parking gratuit"
                star={4.3}
                price="£40 / nuit"
                total="£157 total"
            />
            ...
            <SearchResult
                ...
                description="4 voyageurs · 3 chambres · 4 lits · 2 salles de bain partagées · Wifi · Cuisine · Lave-linge · Sèche-linge"
                star={3.8}
                price="£35 / nuit"
                total="£207 total"
            />
            ...
            <SearchResult
                ...
                description="6 voyageurs · 4 chambres · 6 lits · 3 salles de bain · Wifi · Ascenseur · Arrivée autonome"
                star={4.1}
                price="£55 / nuit"
                total="£320 total"
            />
            ...
            <SearchResult
                ...
                description="2 voyageurs · 1 chambre · 1 lit · 1 salle de bain · Wifi · Cuisine · Ascenseur"
                star={5}
                price="£60 / nuit"
                total="£450 total"
            />
            ...
            <SearchResult
                ...
                description="2 voyageurs · 1 chambre · 1 lit · 1 salle de bain partagée · Wifi · Cuisine · Lave-linge · Sèche-linge"
                star={4.23}
                price="£65 / nuit"
                total="£480 total"
            />
            ...
            <SearchResult
                ...
                description="3 voyageurs · 2 chambres · 3 lits · 1 salle de bain partagée · Wifi · Cuisine · Lave-linge"
                star={3.85}
                price="£90 / nuit"
                total="£650 total"
            />
